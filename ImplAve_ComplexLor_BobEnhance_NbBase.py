...
from my_plot import set_size, lighten_color
...
from hyperfine.bnmr.meissner_ComplexLor_BobEnhance import DepthAveragingCalculator
...
def fcn(
    ...
    enhance_fact_Meissner: float,
    
    norm_enhance_fact_50mT:float,
    norm_enhance_fact_100mT:float,
    norm_enhance_fact_110mT:float,
    norm_enhance_fact_125mT:float,
    norm_enhance_fact_150mT:float,
    norm_enhance_fact_200mT:float,
    ...
    if temperature_K.size == 0:
        return dac(
            ...
            enhance_fact_Meissner,
            
            norm_enhance_fact_50mT,
            norm_enhance_fact_100mT,
            norm_enhance_fact_110mT,
            norm_enhance_fact_125mT,
            norm_enhance_fact_150mT,
            norm_enhance_fact_200mT,
...
# #########################################
# """
cost_used = cost_glob_prop150#cost_glob_init_ET_100
#data_list_df_B_plot
# [data_50mT_Normal_Depthscan, data_100mT_Normal_Depthscan]
# 
...
with open("./Simple_vortex/Complex_Lor/ConstSC_zero/ET_100/no50/AveLor/Unbound_Hesse/ComplexLor_Flat200mT_BobEnhance_NbBase.json", "r") as file_handle:
    old_results = json.load(file_handle)

# initial_params = dict()
# initial_params["dead_layer_nm"] = 11.730515503878543
# initial_params["lambda_L_50mT_nm"] = 17.473906538174763
# initial_params["lambda_L_100mT_nm"] = 42.76786310673041
# initial_params["lambda_L_110mT_nm"] = 65.59859264416136
# initial_params["lambda_L_125mT_nm"] = 127.82898750248205
# initial_params["lambda_L_150mT_nm"] = 187.33631760660182
# initial_params["lambda_L_200mT_nm"] = np.inf

# initial_params["dipolar_field_T"] = 6.211113334436546e-05
# initial_params["correlation_time_s"] = 1.618984137118385e-07

# initial_params["norm_enhance_fact_50mT"] = 1.000
# initial_params["norm_enhance_fact_100mT"] = 1.000
# initial_params["norm_enhance_fact_110mT"] = 1.000 #0.1539682062878489
# initial_params["norm_enhance_fact_125mT"] = 1.000 #1.1102230246251565e-16
# initial_params["norm_enhance_fact_150mT"] = 1.000 #2.4980018054066022e-15
# initial_params["norm_enhance_fact_200mT"] = 0.000

# initial_params["enhance_fact_Meissner"] = 1.081
...
json2minuit(m, "./Simple_vortex/Complex_Lor/ConstSC_zero/ET_100/no50/AveLor/Unbound_Hesse/ComplexLor_Flat200mT_BobEnhance_NbBase.json")
...
# m.values["dead_layer_nm"] = 11.730515503878543

# m.values["dipolar_field_T"] = 6.54647e-05 #6.339851403569519e-05
# m.values["correlation_time_s"] = 1.40561e-07#1.6969938410049679e-07

# m.values["enhance_fact_Meissner"] = 1.081

# m.values["norm_enhance_fact_50mT"] = 1.000
# m.values["lambda_L_50mT_nm"] = 17.473906538174763
# m.errors["lambda_L_50mT_nm"] = m.errors["lambda_L_100mT_nm"]

# m.values["norm_enhance_fact_100mT"] = 1.000#1.081
# m.values["lambda_L_100mT_nm"] = 42.76786310673041

# m.values["norm_enhance_fact_110mT"] = 0.1539682062878489
# m.values["lambda_L_110mT_nm"] = 65.59859264416136
# m.errors["lambda_L_110mT_nm"] = m.errors["lambda_L_100mT_nm"]

# m.values["norm_enhance_fact_125mT"] = 0.000
# m.values["lambda_L_125mT_nm"] = 127.82898750248205
# m.errors["lambda_L_125mT_nm"] = m.errors["lambda_L_100mT_nm"]

# m.values["norm_enhance_fact_150mT"] = 0.000
# m.values["lambda_L_150mT_nm"] = 187.33631760660182
# m.errors["lambda_L_150mT_nm"] = m.errors["lambda_L_100mT_nm"]

# m.values["norm_enhance_fact_200mT"] = 0.000
# m.values["lambda_L_200mT_nm"] = np.inf
# m.errors["lambda_L_200mT_nm"] = m.errors["lambda_L_100mT_nm"]
...
m.fixed["norm_enhance_fact_150mT"] = False
m.fixed["lambda_L_150mT_nm"] = False

###################################################################################

# m.fixed["norm_enhance_fact_100mT"] = True
# m.fixed["norm_enhance_fact_200mT"] = True
...
m.limits["enhance_fact_Meissner"] = (1.000,2.000)


#####################################
#####################################
# m.limits["lambda_L_50mT_nm"] = (0.0,None)
# m.limits["norm_enhance_fact_50mT"] = (0.0,1.000)

m.limits["norm_enhance_fact_150mT"] = (0.0,1.000)
m.limits["lambda_L_150mT_nm"] = None#(0.0,None)

m.limits["norm_enhance_fact_125mT"] = (0.0,1.000)
m.limits["lambda_L_125mT_nm"] = None#(0.0,None)

m.limits["norm_enhance_fact_110mT"] = (0.0,1.000)
m.limits["lambda_L_110mT_nm"] = None#(0.0,None)

#####################################


m.limits["norm_enhance_fact_100mT"] = (0.0,1.000)
...
m.limits["norm_enhance_fact_200mT"] = (0.0,1.000)
m.limits["lambda_L_200mT_nm"] = None#(0.0,None)
...
minuit2json(m, "./Simple_vortex/Complex_Lor/ConstSC_zero/ET_100/no50/AveLor/Unbound_Hesse/ComplexLor_Flat200mT_BobEnhance_NbBase.json")
...
c_Escan = cm.brg(np.linspace(0,0.85,len(cost_used)))
            # [
            # 'red',
            # 'blue',
            # 'brown',
...
for i, data_SCDS in enumerate(cost_used):
    ...
    par_SCDS = [
        ...
        m.values["enhance_fact_Meissner"],    
        
        m.values["norm_enhance_fact_50mT"],
        m.values["norm_enhance_fact_100mT"],
        m.values["norm_enhance_fact_110mT"],
        m.values["norm_enhance_fact_125mT"],
        m.values["norm_enhance_fact_150mT"],
        m.values["norm_enhance_fact_200mT"],
        
        # m.values["B_int_50mT"],
        # m.values["B_int_100mT"],
        # m.values["B_int_110mT"],
        # m.values["B_int_125mT"],
        # m.values["B_int_150mT"],
        # m.values["B_int_200mT"],
...
ax_SCDS_Escan.set_ylim([0.8, 5.0])
