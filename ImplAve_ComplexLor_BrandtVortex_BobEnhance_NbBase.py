...
from hyperfine.bnmr.meissner_ComplexLor_BrandtVortex_BobEnhance import DepthAveragingCalculator
...
with open("./Brandt_vortex/Complex_Lor/ConstSC_zero/no50/AveLor/ComplexLor_Flat200mT_BrandtVortex_BobEnhance_NbBase.json", "r") as file_handle:    
    old_results = json.load(file_handle)

# initial_params = dict()
# initial_params["dead_layer_nm"] = 11.730186020517907
# initial_params["lambda_L_50mT_nm"] = 17.473906538174763
# initial_params["lambda_L_100mT_nm"] = 42.76786310673041
# initial_params["lambda_L_110mT_nm"] = 35.092741193200794
# initial_params["lambda_L_125mT_nm"] = 31.18479386948141
# initial_params["lambda_L_150mT_nm"] = 47.904407526154465
# initial_params["lambda_L_200mT_nm"] = np.inf

# initial_params["dipolar_field_T"] = 6.211117562372681e-05
# initial_params["correlation_time_s"] = 1.6189811876809203e-07

# initial_params["norm_enhance_fact_50mT"] = 1.000
# initial_params["norm_enhance_fact_100mT"] = 1.000
# initial_params["norm_enhance_fact_110mT"] = 1.000 #0.7507931346258396
# initial_params["norm_enhance_fact_125mT"] = 1.000 #0.4650742675824089
# initial_params["norm_enhance_fact_150mT"] = 1.000 #0.43228643186760596
...
json2minuit(m, "./Brandt_vortex/Complex_Lor/ConstSC_zero/no50/AveLor/ComplexLor_Flat200mT_BrandtVortex_BobEnhance_NbBase.json")
...
# minuit2json(m, "./Brandt_vortex/Complex_Lor/ConstSC_zero/no50/AveLor/ComplexLor_Flat200mT_BrandtVortex_BobEnhance_NbBase.json")
...
# # c_B_plot = cm.brg(np.linspace(0,0.85,len(cost_used)))
# # # [
# # #             'blue',
# # #             'brown',
# # #             'grey',
