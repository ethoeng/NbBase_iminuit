...
from hyperfine.bnmr.meissner_wVortex_ComplexLor_BrandtVortex_globfit import DepthAveragingCalculator
...
# with open("./Brandt_vortex/Complex_Lor/ConstSC_zero/no50/AveLor/BrandtVortex_BobNormEnh_BVortexIndep.json", "r") as file_handle:
# with open("./Brandt_vortex/Complex_Lor/ConstSC_zero/no50/AveLor/BrandtVortex_ETNormEnh_BvortexFixedNLocked.json", "r") as file_handle:
with open("./Brandt_vortex/Complex_Lor/ConstSC_zero/no50/AveLor/BrandtVortex_ETNormEnh_BvortexFixedNLocked_Flat200.json", "r") as file_handle:    
...
# initial_params["lambda_L_200mT_nm"] = 200.0
...
# initial_params["suscep_abs_200mT"] = 1.000

# initial_params["B_int_50mT"] = 0.000
# initial_params["B_int_100mT"] = 0.000
# initial_params["B_int_110mT"] = 0.000
# initial_params["B_int_125mT"] = 0.000
# initial_params["B_int_150mT"] = 0.000
# initial_params["B_int_200mT"] = 0.000
...
# json2minuit(m, "./Brandt_vortex/Complex_Lor/ConstSC_zero/no50/AveLor/BrandtVortex_BobNormEnh_BVortexIndep.json")
# json2minuit(m, "./Brandt_vortex/Complex_Lor/ConstSC_zero/no50/AveLor/BrandtVortex_ETNormEnh_BvortexFixedNLocked.json")
json2minuit(m, "./Brandt_vortex/Complex_Lor/ConstSC_zero/no50/AveLor/BrandtVortex_ETNormEnh_BvortexFixedNLocked_Flat200.json")
...
# m.values["lambda_L_50mT_nm"] = 42.76786310673041

# m.values["demag_fact"] = enhance_to_demag(enhance_fact=1.081)

# m.values["suscep_abs_50mT"] = 1.000

# m.values["B_int_50mT"] = 0.000
# m.values["B_int_100mT"] = 0.000
# m.values["B_int_110mT"] = 0.000
# m.values["B_int_125mT"] = 0.000
# m.values["B_int_150mT"] = 0.000

# m.values["const_SC"] = 0.0
# m.values["const_NC"] = 0.0

# m.values["critical_temperature_K"] = 9.25

####################################
# m.values["suscep_abs_150mT"] = 1.0
# m.values["lambda_L_150mT_nm"] = 150.0

####################################
# m.values["lambda_L_125mT_nm"] = 125.0#42.76786310673041
# m.values["suscep_abs_125mT"] = 1.000

####################################
# m.values["lambda_L_110mT_nm"] = 80.0#42.76786310673041
# m.values["suscep_abs_110mT"] = 1.000
####################################
# m.values["dead_layer_nm"] = 11.730515503878543
# m.values["lambda_L_100mT_nm"] = 42.76786310673041
# m.values["suscep_abs_100mT"] = 1.000

# m.values["dipolar_field_T"] = 6.211113334436546e-05
# m.values["correlation_time_s"] = 1.618984137118385e-07

# m.values["B_int_200mT"] = np.inf#0.100
# m.values["suscep_abs_200mT"] = 0.000#1.000 
# m.values["lambda_L_200mT_nm"] = np.inf #42.76786310673041#100.0 #
#####################################
...
# m.fixed["B_int_200mT"] = False ##[For ET model, always fixed (coupled to suscep)]
###################################################################################
...
# minuit2json(m, "./Brandt_vortex/Complex_Lor/ConstSC_zero/no50/AveLor/BrandtVortex_BobNormEnh_BVortexIndep.json")
# minuit2json(m, "./Brandt_vortex/Complex_Lor/ConstSC_zero/no50/AveLor/BrandtVortex_ETNormEnh_BvortexFixedNLocked.json")
# minuit2json(m, "./Brandt_vortex/Complex_Lor/ConstSC_zero/no50/AveLor/BrandtVortex_ETNormEnh_BvortexFixedNLocked_Flat200.json")
